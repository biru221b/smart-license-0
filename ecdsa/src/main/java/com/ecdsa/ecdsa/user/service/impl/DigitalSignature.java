...
public class DigitalSignature {
    ...
    public void generateQR(int userId) throws JSONException, WriterException, IOException{
        try {
            ...
            JSONObject obj = digiSig.signMessage(userDetail.getName()+"|"+userDetail.getAddress()+"|"+userDetail.getDOB()+"|"+userDetail.getDOI()+"|"+userDetail.getDOE()+"|"+userDetail.getCitizenShipNo()+"|"+userDetail.getCategory());
